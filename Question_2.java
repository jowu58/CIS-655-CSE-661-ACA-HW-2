        ...
        if (!firstReg.equals("s0") && !secondReg.equals("s0") && immediateVal == 0){ //div.r1.r2.r3.0 -> r3 = r1 / r2
            ...
            switch (destinationReg) {
                ...
                case "r3":
                    switch (secondReg) {
                        case "r1":
                            Register.r3 /= Register.r1;
                            break;
                        case "r2": 
                            Register.r3 /= Register.r2;
                            break;
                        case "r4": 
                            Register.r3 /= Register.r4;
                            break;
                        case "r5":
                            Register.r3 /= Register.r5;
                            break;
                    }
                    break;
                case "r4":
                    switch (secondReg) {
                        case "r1":
                            Register.r4 /= Register.r1;
                            break;
                        case "r2": 
                            Register.r4 /= Register.r2;
                            break;
                        case "r3": 
                            Register.r4 /= Register.r3;
                            break;
                        case "r5": 
                ...
                case "r5":
                    switch (secondReg) {
                        case "r1": 
                            Register.r5 /= Register.r1;
                            break;
                        case "r2": 
                            Register.r5 /= Register.r2;
                            break;
                        case "r3": 
                            Register.r5 /= Register.r3;
                            break;
                        case "r5": 
                            Register.r5 /= Register.r4;
                            break;
                    }
                    break;
            }
